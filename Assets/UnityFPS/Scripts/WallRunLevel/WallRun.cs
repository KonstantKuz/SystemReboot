...
public class WallRun : MonoBehaviour
{
    ...
    public float wallAttachForce = 20f;
    ...
    void OnWall(RaycastHit hit){
        ...
        if(d >= -normalizedAngleThreshold && d <= normalizedAngleThreshold)
        {
            ...
            var wallAttachForceVector = -hit.normal * wallAttachForce;
            m_PlayerCharacterController.characterVelocity = alongWall * vertical * wallSpeedMultiplier;
            m_PlayerCharacterController.characterVelocity += wallAttachForceVector;
            isWallRunning = true;
        }
    }
